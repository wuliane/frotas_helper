  ...
  Future<void> _loadVehicles() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Erro ao carregar veículos: $error'),
        ),
      );
    } finally {
      if (mounted) {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            'Deseja excluir ${vehicle.brand} ${vehicle.model}, placa ${vehicle.plate}?',
          ),
          actions: [
            TextButton(
              onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _loading
          ...
          : _vehicles.isEmpty
              ? _EmptyVehicles(onAdd: _openAddVehicle)
              : RefreshIndicator(
                                    ...
                                    Wrap(
                                      ...
                                      children: [
                                        ...
                                        _InfoChip(
                                          ...
                                          label:
                                              '${_currencyFormatter.format(vehicle.rentalValue)}/semana',
                                        ),
                                      ],
                                    ),
